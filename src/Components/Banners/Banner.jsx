const Banner = () => {
  return (
    <div className="min-h-[600px] max-h-[800px] bg-no-repeat bg-cover " style={{backgroundImage: `url(https://media.istockphoto.com/id/1193842936/photo/mobile-communication-concept-global-communication-network.webp?b=1&s=170667a&w=0&k=20&c=oHUUjJBFUM47PBu24btnPFkPiZUd1Cs2jG_2mV4oGds=)`}}>
      <div className="min-h-[600px] sm:px-2 px-3 max-h-[800px] py-20 bg-[#000000ab] ">
      ...
      {/* Beautiful announcement line */}
        <div className="bg-[#1F2937] mx-auto max-w-[250px] pr-3 pl-1 py-[6px]  rounded-full gap-2 flex  items-center text-white">
          <span className="bg-sky-300 text-black sm:px-3 px-2 sm:py-1 py-[3px] sm:text-base text-sm rounded-full">
            New
          </span>
          Smc product added
        </div>
        ...
        <div className="mt-10 ">
          ...
          <div className="mt-5 flex md:flex-row max-w-[450px] mx-auto justify-center gap-2 flex-col">
             ...
             <div className=" md:mr-auto md:ml-0 lg:w-[55%] ">
                   <button className="bg-sky-300 sm:py-3 py-2 sm:text-base text-sm px-3 text-black rounded-lg ">Get Early Acess</button>
             </div>
          </div>
        </div>
      </div>
