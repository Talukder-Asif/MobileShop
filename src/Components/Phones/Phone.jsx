...
const Phone = ({ phone }) => {
    ...
    const handleAddCard = ()=>{
        ...
        if(!availableCard){
            ...
            const isAvailable = availableCard.find(phones => phones.id === phone.id)
            if(isAvailable){
  ...
  return (
    <div className="w-full m-auto flex flex-col justify-between max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          <button onClick={() => handleAddCard()} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Add to card
          </button>
